      ...
      <div className="dashboard-header">
        ...
        <div className="header-right">
          ...
          <div className="header-actions">
            ...
            <Link to="/mcp-inspector" className="token-info-btn" title="MCP discovery & tools/call (demo)" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', padding: '0 10px', fontSize: '0.8rem', fontWeight: 600 }}>
              MCP
            </Link>
