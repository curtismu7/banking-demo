...
const ROWS = [
  ...
  { rfc: 'RFC 7519', name: 'JWT', app: 'Access tokens T1, T2, …', href: 'https://datatracker.ietf.org/doc/html/rfc7519', panel: EDU.LOGIN_FLOW, tab: 'tokens' },
  ...
  { rfc: 'RFC 7662', name: 'Token Introspection', app: 'MCP validates T2', href: 'https://datatracker.ietf.org/doc/html/rfc7662', panel: EDU.INTROSPECTION, tab: 'why' },
  { rfc: 'RFC 8693', name: 'Token Exchange', app: 'BFF T1→T2', href: 'https://datatracker.ietf.org/doc/html/rfc8693', panel: EDU.TOKEN_EXCHANGE, tab: 'after' },
  ...
  { rfc: 'RFC 7523', name: 'JWT Client Auth', app: 'client_assertion in exchange', href: 'https://datatracker.ietf.org/doc/html/rfc7523', panel: EDU.TOKEN_EXCHANGE, tab: 'after' },
